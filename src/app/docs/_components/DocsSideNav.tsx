  ...
  return (
    <nav className="h-full flex flex-col">
      ...
      <div className="px-4 py-5 border-b border-sidebar-border flex-shrink-0">
        ...
        <p className="text-xs font-semibold text-primary-600 uppercase tracking-widest mb-0.5">Documentation</p>
              ...
              {group.items.map((item) => {
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      {isActive && (
                        <span className="mr-2 w-1 h-1 rounded-full bg-sidebar-active flex-shrink-0" />
                      )}
                      {item.label}
                    </Link>
                  </li>
